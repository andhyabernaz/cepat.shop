...
class Installer
{
   ...
   public static function createDbTables($host, $port, $database, $username, $password, $prefix = '')
   {
   ...
   public static function saveDbVariables($host, $port, $database, $username, $password, $prefix = '')
   {
   ...
   public function setDefaultData(array $params)
   {
      \App\Models\User::updateOrCreate();
   }

   public static function finalTouches($params = [])
   {
      // Update .env file
      $env = [
         'APP_INSTALLED'         =>  'true',
