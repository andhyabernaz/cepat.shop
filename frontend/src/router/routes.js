const routes = [
   {
      ...
      children: [
         ...
         { path: 'page/:slug', name: 'FrontPageShow', component: () => import('src/pages/Front/PageDetail.vue') },
   ...
   },
   {
      ...
      children: [
         ...
         { path: 'sales', name: 'AdminSales', component: () => import('src/pages/Dashboard/AdminDashboard.vue'), props: { initialSection: 'sales' } },
         { path: 'reports', name: 'AdminReport', component: () => import('src/pages/Dashboard/AdminDashboard.vue'), props: { initialSection: 'reports' } },
         ...
         { path: 'pages', name: 'AdminPageIndex', component: () => import('src/pages/Page/Index.vue') },
         ...
         { path: 'page/create', name: 'PageCreate', component: () => import('src/pages/Page/PageForm.vue') },
         { path: 'page/edit/:id', name: 'PageEdit', component: () => import('src/pages/Page/PageForm.vue') },
